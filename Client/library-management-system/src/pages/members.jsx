  ...
  const fetchMembers = useCallback(
    async (targetPage = page) => {
      try {
        ...
        setTotalCount(
          res.data?.pagination?.totalMembers ||
  ...
  const downloadFineReport = async () => {
    try {
      ...
      if (reportData.length === 0) {
        alert("No outstanding fines found. Everyone is up to date!");
        return;
      }
      ...
      setError(
        "Error generating report. Ensure jspdf-autotable is correctly installed.",
      );
    } finally {
      setLoading(false);
    }
    ...
    <div className="p-6 bg-white rounded-xl shadow w-full space-y-6 text-gray-800">
      ...
      <div className="flex flex-wrap gap-3 p-4 bg-gray-50 rounded-lg items-end">
        <div className="flex-grow">
          <label className="label-text text-xs font-bold mb-1 block">
            Search
          </label>
          <input
      ...
      <div className="card bg-indigo-600 text-white shadow-xl">
        <div className="card-body items-center text-center">
          ...
          <p className="opacity-80">
            Generate a PDF of all members with outstanding balances.
          </p>
                ...
                <tr key={m._id} className="hover">
                  ...
                  <td>
                    {m.classId?.name ? (
                      ...
                      <span className="badge badge-ghost italic opacity-50">
                        Unassigned
                      </span>
                    )}
                  </td>
